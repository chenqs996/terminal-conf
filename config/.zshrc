...
plugins=(git extract z cp safe-paste colored-man-pages zsh-history-substring-search zsh-syntax-highlighting zsh-completions zsh-autosuggestions)
...
#export PATH=/opt/pb_generator:$PATH
[[ -f /opt/nvim/nvimrc ]] && source /opt/nvim/nvimrc

[[ ! -f ~/.ros.zsh ]] || source ~/.ros.zsh
